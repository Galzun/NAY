...
export default function Lor({visibleLor, setvisibleLor, onVote, setvisibleTelegram}) {
                ...
                <div className='container'>
                    <div className='slayking'>
                        <div className="slayking__close">
                            <span onClick={() => setvisibleLor(false)} ></span>
                        </div>
                        <div className="slayking__header">
                            ...
                            <p className="slayking__header-text">
                                От него ни скроется не одна информация, что не спроси, всё знает о каждом и всё расскажет о любой ситуации, даже о тебе... Да да, я про тебя говорю 0_0 про тебя они многое знают
                            </p>
                            ...
                            <div className="slayking__header-img">
                                <img src={streamerImages["Lor"]}></img>
                            </div>
                        </div>
